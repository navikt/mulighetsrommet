...
Grensesnitt for å definere toggles finner du her: https://teamvalp-unleash-web.nav.cloud.nais.io.
...
1. Opprett miljøvariabelen `UNLEASH_SERVER_API_URL` med verdi: https://teamvalp-unleash-api.nav.cloud.nais.io/api
