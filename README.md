...
- [Opentelemetry-metrikker fra frontend](https://grafana.nav.cloud.nais.io/d/k8g_nks4z/frontend-web-vitals?orgId=1&var-app=arbeidsmarkedstiltak-flate&var-env=prod-gcp-loki&from=now-15m&to=now)
