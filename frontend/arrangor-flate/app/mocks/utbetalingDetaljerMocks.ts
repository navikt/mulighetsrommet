...
export const arrFlateUtbetaling: ArrFlateUtbetaling[] = [
  {
    ...
    beregning: {
      type: "ArrFlateBeregningPrisPerManedsverkMedDeltakelsesmengder",
      belop: 10149,
      sats: 129,
      digest: "b3602d2a",
      deltakelser: [
        {
          type: "ArrFlateBeregningDeltakelsePrisPerManedsverkMedDeltakelsesmengder",
          ...
          faktor: 0.48387,
          person: { navn: "Nordmann, Ola", foedselsdato: "1993-11-01", norskIdent: "" },
