...
export default function Notatkort() {
  const notatkortListe = [
    {
      id: "1",
      opprettetAv: { navident: "H123242", navn: "Tania Holst" },
    ...
    {
      id: "2",
      opprettetAv: { navident: "H123242", navn: "Veileder Veiledersen" },
      opprettetDato: "2023-01-19 14:03:07",
      innhold:
        ...
        return (
          <div className={styles.notatkort} key={id}>
            <span className={styles.notatinformasjon}>
              <BodyShort>Lagt til av: {notatkort.opprettetAv.navn}</BodyShort>
