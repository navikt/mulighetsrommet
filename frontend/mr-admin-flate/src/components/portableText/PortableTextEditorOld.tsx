...
function PortableTextEditorOld(props: PortableTextEditorProps, _: ForwardedRef<HTMLElement>) {
  const {
    placeholder,
                ...
                >
                  <ToolbarComponent>
                    ...
                    <BlockButton
                      ...
                      icon={
                        <div>
                          <BulletListIcon aria-label="Bullet" /> Bullets
                        </div>
                      }
                    />
                    <LinkButton />
...
const PortableTextEditorComponent = React.forwardRef(PortableTextEditorOld);

export { PortableTextEditorComponent as PortableTextEditorOld };
