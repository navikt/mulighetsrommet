...
export const avtalenErAvsluttet = (erRedigeringsmodus: boolean) => (
  <>
    <BodyShort>
      Kan ikke {erRedigeringsmodus ? "redigere" : "opprette"} gjennomføring
      fordi avtalens sluttdato har passert.
    </BodyShort>
    <BodyShort>
      Ta <a href={PORTEN}>kontakt i Porten</a> dersom du trenger mer hjelp.
    </BodyShort>
...
const avtaleManglerNavRegionError = (avtaleId?: string) => (
  <>
    <BodyShort>
      Avtalen mangler NAV region. Du må oppdatere avtalens NAV region for å
      kunne opprette en gjennomføring.
      {avtaleId ? (
...
export const tekniskFeilError = () => (
  <>
    ...
    <BodyShort>
      Forsøk på nytt, eller ta <a href={PORTEN}>kontakt i Porten</a> dersom du
      trenger mer hjelp.
    </BodyShort>
  </>
);
