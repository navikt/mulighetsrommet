...
export const notificationHandlers = [
  http.get<PathParams, PaginertUserNotifications>("*/api/v1/internal/notifications", () =>
    HttpResponse.json(mockNotifikasjoner),
  ),
  http.get<PathParams, UserNotificationSummary>("*/api/v1/internal/notifications/summary", () =>
    HttpResponse.json(mockUserNotificationSummary),
  ),
  http.post<PathParams, null>("*/api/v1/internal/notifications/:id/status", () =>
    HttpResponse.json(),
  ),
];
