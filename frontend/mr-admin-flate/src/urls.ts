...
export const DELTAKERLISTE_KOMET = {
  ...
  development:
    "https://www.intern.dev.nav.no/amt/amt-deltakerliste-flate/bundle.js", // URL til bundle som blir hostet et sted i dev
  production: "", // URL til bundle som blir hostet et sted i prod
};

export const pocBaseCdnUrl = `${
  DELTAKERLISTE_KOMET[getEnvironment()]
}/bundle.js`;
export const pocManifestUrl = `${
  DELTAKERLISTE_KOMET[getEnvironment()]
}/manifest.json`;
