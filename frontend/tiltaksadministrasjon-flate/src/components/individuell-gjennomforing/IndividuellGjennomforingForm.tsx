...
export function IndividuellGjennomforingForm() {
  const { watch, setValue } = useFormContext<IndividuellGjennomforingFormValues>();
  ...
  return (
    <VStack gap="space-16">
      ...
      <FormComboboxMulti<IndividuellGjennomforingFormValues>
