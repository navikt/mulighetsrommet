package no.nav.mulighetsrommet.api.tiltakdokument.task
    ...
    suspend fun migrer() {
        ...
        for (tiltak in alleDokumenter) {
            ...
            runCatching {
                ...
                val eksisterende = db.session { queries.tiltakDokument.getBySanityId(sanityId) }
                ...
                db.transaction {
                    ...
                    queries.tiltakDokument.setNavEnheter(id, navEnheter)
                }
