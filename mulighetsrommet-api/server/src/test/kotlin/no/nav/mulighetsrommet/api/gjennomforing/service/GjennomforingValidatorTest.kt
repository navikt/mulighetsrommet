...
import no.nav.mulighetsrommet.api.domain.testing.fixture.NavEnhetFixtures.TiltakOslo
...
class GjennomforingValidatorTest : FunSpec({
    ...
    val kategoriseringCtx = GjennomforingValidator.Context.Kategorisering(
