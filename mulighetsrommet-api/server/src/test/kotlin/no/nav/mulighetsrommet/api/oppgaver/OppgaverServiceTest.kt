...
class OppgaverServiceTest : FunSpec({
    ...
    context("enkeltplasser") {
        ...
        test("enkeltplass oppgaver vises ikke når feature toggle er skrudd av") {
            ...
            OppgaverService(database.api, features(enkeltplassFilterEnabled = false)).oppgaver(
                oppgavetyper = setOf(),
                tiltakskoder = setOf(),
                navEnheter = setOf(),
                arrangorer = setOf(),
    ...
    context("tilskuddsbehandlinger") {
            ...
            MulighetsrommetTestDomain(
                ...
                queries.tilskuddBehandling.upsert(
                    TilskuddFixtures.Behandling.copy(
                        ...
                        tilskudd = listOf(TilskuddFixtures.TilskuddVedtakInnvilgelse),
                    ),
                )
                setGodkjent(
                    TilskuddFixtures.Behandling.id,
        ...
        test("arrangor-filter begrenser tilskuddsbehandling oppgaver") {
            ...
            val behandlingOslo = TilskuddFixtures.Behandling.copy(
                ...
                id = UUID.randomUUID(),
                tilskudd = listOf(TilskuddFixtures.TilskuddVedtakInnvilgelse.copy(id = UUID.randomUUID())),
            )
