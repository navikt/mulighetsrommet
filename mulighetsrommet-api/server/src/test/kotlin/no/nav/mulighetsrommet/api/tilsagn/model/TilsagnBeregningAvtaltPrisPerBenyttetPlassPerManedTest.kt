...
class TilsagnBeregningAvtaltPrisPerBenyttetPlassPerManedTest : FunSpec({
    ...
    val avtaltPrisPerBenyttetPlasPerManedInput = TilsagnBeregningAvtaltPrisPerBenyttetPlassPerManed.Input(
    ...
    test("en plass en måned = sats") {
        val input = avtaltPrisPerBenyttetPlasPerManedInput.copy(
            periode = Periode.forMonthOf(LocalDate.of(2024, 1, 1)),
            sats = 20205.NOK,
            antallPlasser = 1,
        )
    ...
    test("beregningen tar høyde for variabelt antall dager ifm. skuddår") {
        val ikkeSkuddar = avtaltPrisPerBenyttetPlasPerManedInput.copy(
        ...
        val skuddar = avtaltPrisPerBenyttetPlasPerManedInput.copy(
