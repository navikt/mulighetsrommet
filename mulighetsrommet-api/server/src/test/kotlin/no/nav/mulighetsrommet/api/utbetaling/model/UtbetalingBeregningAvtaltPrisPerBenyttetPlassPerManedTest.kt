...
class UtbetalingBeregningAvtaltPrisPerBenyttetPlassPerManedTest : FunSpec({
    ...
    context("enkel beregning full og halv") {
        test("deltakere med ulike perioder beregnes korrekt") {
            ...
            val gjennomforing = createGjennomforingForPrisPerManedsverk(
                periode = periode,
                satser = listOf(AvtaltSats(periodeStart, 100.NOK)),
            )
            val deltakere = listOf(
            ...
            result.input shouldBe UtbetalingBeregningAvtaltPrisPerBenyttetPlassPerManed.Input(
            ...
            result.output shouldBe UtbetalingBeregningAvtaltPrisPerBenyttetPlassPerManed.Output(
                pris = 200.NOK,
                deltakelser = setOf(
    ...
    test("utbetaling og tilsagn er likt for forskjellige perioder av en måned") {
        ...
        val gjennomforing = createGjennomforingForPrisPerManedsverk(
            periode = periode,
            satser = listOf(AvtaltSats(periode.start, 20205.NOK)),
        )
