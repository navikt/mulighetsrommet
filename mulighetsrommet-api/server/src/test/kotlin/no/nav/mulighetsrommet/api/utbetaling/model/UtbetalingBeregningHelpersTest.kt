...
class UtbetalingBeregningHelpersTest : FunSpec({
    test("skal utlede deltakelsesperioder over flere satser") {
        ...
        val satser = setOf(
            SatsPeriode(Periode(uke1Start, uke4Start), 1.NOK),
            SatsPeriode(Periode(uke4Start, periodeSlutt), 2.NOK),
        )
    ...
    test("beregner hele ukesverk og utleder sammenhengede deltakelsesperioder fordelt på satsene") {
        ...
        val satser = setOf(
            SatsPeriode(sats1Periode, 100.NOK),
            SatsPeriode(sats2Periode, 150.NOK),
            SatsPeriode(sats3Periode, 200.NOK),
        )
    ...
    test("beregner hele ukesverk og trekker fra stengte perioder 2") {
        ...
        val satser = setOf(SatsPeriode(sats1Periode, 100.NOK), SatsPeriode(sats2Periode, 150.NOK))
