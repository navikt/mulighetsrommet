...
class DelMedBrukerServiceTest : FunSpec({
    ...
    context("DelMedBrukerService") {
        ...
        test("hent siste delinger med bruker per tiltak sortert etter nyeste først") {
            val tiltakDokumentId = UUID.randomUUID()
            ...
            service.getAll(fnr = NorskIdent("12345678910")).should {
                ...
                it[2].tiltak.id shouldBe GjennomforingFixtures.Oppfolging1.id
                it[2].dialogId shouldBe "1"
            }
        }
