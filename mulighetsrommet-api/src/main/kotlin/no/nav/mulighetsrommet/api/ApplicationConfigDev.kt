...
val ApplicationConfigDev = AppConfig(
    ...
    auth = AuthConfig(
        ...
        roles = setOf(
            ...
            AdGruppeNavAnsattRolleMapping(
                adGruppeId = "95dfba28-62da-49fb-ae3c-237573c6eaeb".toUUID(),
                kommentar = "1900-CA-Tiltaksadministrasjon_attestant-utbetaling",
                rolle = Rolle.ATTESTANT_UTBETALING,
                enheter = setOf(NavEnhetNummer("1900")),
            ),
            AdGruppeNavAnsattRolleMapping(
                adGruppeId = "35c4d0f9-a7ac-4588-8762-5913cb787058".toUUID(),
