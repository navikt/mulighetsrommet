    ...
    tiltakstyper = TiltakstypeService.Config(
        features = run {
            ...
            mapOf(
                ...
                Tiltakskode.ARBEIDSTRENING to vises,
                Tiltakskode.MIDLERTIDIG_LONNSTLSKUDD to vises,
                Tiltakskode.VARIG_LONNSTILSKUD to vises,
                Tiltakskode.MENTOR to vises,
                Tiltakskode.INKLUDERINGSTILSKUD to vises,
                Tiltakskode.SOMMERJOBB to vises,
                Tiltakskode.VTAO to vises,
                Tiltakskode.FIREARIG_LONNSTILSUDD to vises,
            )
        },
    ),
    okonomi = run {
