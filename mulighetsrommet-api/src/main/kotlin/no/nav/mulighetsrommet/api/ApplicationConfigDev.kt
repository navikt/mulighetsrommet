    ...
    tiltakstyper = TiltakstypeService.Config(
        features = run {
            ...
            mapOf(
                ...
                Tiltakskode.ENKELTPLASS_ARBEIDSMARKEDSOPPLAERING to admin + modia + migrertInnhold,
                Tiltakskode.ENKELTPLASS_FAG_OG_YRKESOPPLAERING to admin + modia + migrertInnhold,
                Tiltakskode.HOYERE_UTDANNING to admin + modia + migrertInnhold,
                Tiltakskode.HOYERE_YRKESFAGLIG_UTDANNING to admin + modia + migrertInnhold,
