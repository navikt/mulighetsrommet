...
import no.nav.mulighetsrommet.api.utbetaling.service.tidligstTidspunktForUtbetalingProd
...
val ApplicationConfigProd = AppConfig(
    tiltakstyper = TiltakstypeService.Config(
        features = run {
            ...
            mapOf(
                Tiltakskode.GRUPPE_ARBEIDSMARKEDSOPPLAERING to admin + modia + migrert + utfaset + migrertInnhold,
                Tiltakskode.GRUPPE_FAG_OG_YRKESOPPLAERING to admin + modia + migrert + utfaset + migrertInnhold,

                Tiltakskode.ARBEIDSMARKEDSOPPLAERING to admin + modia + migrert + migrertInnhold,
                Tiltakskode.ARBEIDSFORBEREDENDE_TRENING to admin + modia + migrert + migrertInnhold,
                Tiltakskode.ARBEIDSRETTET_REHABILITERING to admin + modia + migrert + migrertInnhold,
                Tiltakskode.AVKLARING to admin + modia + migrert + migrertInnhold,
                Tiltakskode.DIGITALT_OPPFOLGINGSTILTAK to admin + modia + migrert + migrertInnhold,
                Tiltakskode.FAG_OG_YRKESOPPLAERING to admin + modia + migrert + migrertInnhold,
                Tiltakskode.JOBBKLUBB to admin + modia + migrert + migrertInnhold,
                Tiltakskode.NORSKOPPLAERING_GRUNNLEGGENDE_FERDIGHETER_FOV to admin + modia + migrert + migrertInnhold,
                Tiltakskode.OPPFOLGING to admin + modia + migrert + migrertInnhold,
                Tiltakskode.STUDIESPESIALISERING to admin + modia + migrert + migrertInnhold,
                Tiltakskode.VARIG_TILRETTELAGT_ARBEID_SKJERMET to admin + modia + migrert + migrertInnhold,

                Tiltakskode.ENKELTPLASS_ARBEIDSMARKEDSOPPLAERING to modia + migrertInnhold,
                Tiltakskode.ENKELTPLASS_FAG_OG_YRKESOPPLAERING to modia + migrertInnhold,
                Tiltakskode.HOYERE_UTDANNING to modia + migrertInnhold,
                Tiltakskode.HOYERE_YRKESFAGLIG_UTDANNING to modia + migrertInnhold,
                Tiltakskode.ARBEIDSTRENING to modia + migrertInnhold,
                Tiltakskode.MIDLERTIDIG_LONNSTLSKUDD to modia + migrertInnhold,
                Tiltakskode.VARIG_LONNSTILSKUD to modia + migrertInnhold,
                Tiltakskode.MENTOR to modia + migrertInnhold,
                Tiltakskode.INKLUDERINGSTILSKUD to modia + migrertInnhold,
                Tiltakskode.SOMMERJOBB to modia + migrertInnhold,
                Tiltakskode.VTAO to modia + migrertInnhold,
                Tiltakskode.INDIVIDUELL_JOBBSTOTTE_UNG to modia + migrertInnhold,
                Tiltakskode.INDIVIDUELL_JOBBSTOTTE to modia + migrertInnhold,
                Tiltakskode.ARBEID_MED_STOTTE to modia + migrertInnhold,
    ...
    auth = AuthConfig(
        ...
        roles = setOf(
            ...
            EntraGroupNavAnsattRolleMapping(
                ...
                kostnadssteder = setOf(NavEnhetNummer("0200")),
            ),
            EntraGroupNavAnsattRolleMapping(
            ...
            EntraGroupNavAnsattRolleMapping(
                ...
                rolle = Rolle.ATTESTANT_UTBETALING,
                kostnadssteder = setOf(NavEnhetNummer("0600")),
            ),
            EntraGroupNavAnsattRolleMapping(
            ...
            EntraGroupNavAnsattRolleMapping(
                ...
                rolle = Rolle.ATTESTANT_UTBETALING,
                kostnadssteder = setOf(NavEnhetNummer("0800")),
            ),
            EntraGroupNavAnsattRolleMapping(
            ...
            EntraGroupNavAnsattRolleMapping(
                ...
                rolle = Rolle.ATTESTANT_UTBETALING,
                kostnadssteder = setOf(NavEnhetNummer("1000")),
            ),
            EntraGroupNavAnsattRolleMapping(
            ...
            EntraGroupNavAnsattRolleMapping(
                ...
                rolle = Rolle.ATTESTANT_UTBETALING,
                kostnadssteder = setOf(NavEnhetNummer("1100")),
            ),
            EntraGroupNavAnsattRolleMapping(
            ...
            EntraGroupNavAnsattRolleMapping(
                ...
                rolle = Rolle.ATTESTANT_UTBETALING,
                kostnadssteder = setOf(NavEnhetNummer("1200")),
            ),
            EntraGroupNavAnsattRolleMapping(
            ...
            EntraGroupNavAnsattRolleMapping(
                ...
                rolle = Rolle.ATTESTANT_UTBETALING,
                kostnadssteder = setOf(NavEnhetNummer("1500")),
            ),
            EntraGroupNavAnsattRolleMapping(
            ...
            EntraGroupNavAnsattRolleMapping(
                ...
                rolle = Rolle.ATTESTANT_UTBETALING,
                kostnadssteder = setOf(NavEnhetNummer("1800")),
            ),
            EntraGroupNavAnsattRolleMapping(
            ...
            EntraGroupNavAnsattRolleMapping(
                ...
                rolle = Rolle.ATTESTANT_UTBETALING,
                kostnadssteder = setOf(NavEnhetNummer("1900")),
            ),
            EntraGroupNavAnsattRolleMapping(
