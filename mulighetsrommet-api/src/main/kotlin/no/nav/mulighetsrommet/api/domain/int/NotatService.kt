...
interface NotatService {
    fun getAllAvtaleNotater(filter: AvtaleNotatFilter): StatusResponse<List<AvtaleNotatDto>>
    ...
    fun getAllTiltaksgjennomforingNotater(filter: TiltaksgjennomforingNotatFilter): StatusResponse<List<TiltaksgjennomforingNotatDto>>
