...
class ArenaAdapterService(
    ...
    private suspend fun upsertGruppetiltak(
        ...
        val mergedArenaGjennomforing = mergeWithCurrentGjennomforing(arenaGjennomforing, previous)

        if (hasNoRelevantChanges(mergedArenaGjennomforing, previous)) {
    ...
    ): ArenaTiltaksgjennomforingDbo = ArenaTiltaksgjennomforingDbo(
