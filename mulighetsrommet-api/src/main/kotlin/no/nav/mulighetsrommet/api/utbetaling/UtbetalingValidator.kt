...
object UtbetalingValidator {
    ...
    private fun invalidGjennomforingOpprettKrav(gjennomforing: Gjennomforing): Nothing = throw IllegalArgumentException("Kan ikke opprette utbetalingskrav for ${gjennomforing.tiltakstype.navn} med ${gjennomforing.prismodell.type.navn}")
