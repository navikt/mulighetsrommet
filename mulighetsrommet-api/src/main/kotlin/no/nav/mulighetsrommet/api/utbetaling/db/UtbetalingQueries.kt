...
class UtbetalingQueries(private val session: Session) {
        ...
        when (dbo.beregning) {
            ...
            is UtbetalingBeregningPrisPerUkesverk -> {
                ...
                val perioder = dbo.beregning.input.deltakelser
                    .map { DeltakelseDeltakelsesprosentPerioder(it.deltakelseId, listOf(DeltakelsesprosentPeriode(it.periode, 100.0))) }
                    .toSet()
    ...
    private fun Session.upsertUtbetalingBeregningInputDeltakelsePerioder(id: UUID, perioder: Set<DeltakelseDeltakelsesprosentPerioder>) {
        @Language("PostgreSQL")
