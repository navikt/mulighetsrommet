...
select * from (values
    ...
    ('GRUPPE_ARBEIDSMARKEDSOPPLAERING'::tiltakskode, 'SPRAKKUNNSKAP', 'ALLTID'::personopplysning_frekvens),
...
select * from (values
    ...
    ('ARBEIDSRETTET_REHABILITERING'::tiltakskode, 'SPRAKKUNNSKAP', 'OFTE'::personopplysning_frekvens),
