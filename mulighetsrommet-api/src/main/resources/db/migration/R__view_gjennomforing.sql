...
select gjennomforing.id,
       ...
       avrop.created_at            as opprettet_tidspunkt,
       avrop.updated_at            as oppdatert_tidspunkt,
       avrop.navn,
       avrop.start_dato,
       avrop.slutt_dato,
       avrop.apent_for_pamelding,
       avrop.antall_plasser,
       avrop.avtale_id,
       avrop.oppstart,
       avrop.beskrivelse,
       avrop.faneinnhold,
       avrop.deltidsprosent,
       avrop.estimert_ventetid_verdi,
       avrop.estimert_ventetid_enhet,
       avrop.sted_for_gjennomforing,
       avrop.oppmote_sted,
       avrop.publisert,
       avrop.avbrutt_aarsaker,
       avrop.avbrutt_forklaring,
       avrop.avsluttet_tidspunkt,
       avrop.tilgjengelig_for_arrangor_dato,
       avrop.status,
       ...
       avtale.prismodell
from gjennomforing_avrop avrop
         join avtale on avtale.id = avrop.avtale_id
         join gjennomforing on avrop.gjennomforing_id = gjennomforing.id
