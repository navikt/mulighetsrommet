...
class ArenaAdapterServiceTest : FunSpec({
    ...
    context("tiltak i egen regi") {
        val gjennomforing = ArenaGjennomforingDbo(
            ...
            sanityId = null,
            navn = "IPS",
            arenaKode = TiltakstypeFixtures.IPS.tiltakskode?.arenakode ?: "",
            tiltaksnummer = "12345",
    ...
    context("gruppetiltak") {
        ...
        test("tillater ikke opprettelse av gjennomføringer fra Arena") {
            ...
            val arenaGjennomforing = ArenaGjennomforingDbo(
                ...
                navn = "Oppfølging",
                sanityId = null,
                arenaKode = TiltakstypeFixtures.Oppfolging.tiltakskode?.arenakode ?: "",
                tiltaksnummer = "12345",
                arrangorOrganisasjonsnummer = "976663934",
                startDato = LocalDate.now(),
                sluttDato = LocalDate.now().plusYears(1),
    ...
    context("enkeltplasser") {
        ...
        val arenaGjennomforing = ArenaGjennomforingDbo(
            ...
            navn = "En enkeltplass",
            sanityId = null,
            arenaKode = TiltakstypeFixtures.EnkelAmo.tiltakskode?.arenakode ?: "",
