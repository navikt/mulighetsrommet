    ...
    FunSpec({
        ...
        context("CRUD") {
            ...
            test("upsert genererer nye løpenummer") {
                ...
                avtaler.upsert(AvtaleFixtures.oppfolging.copy(avtalenummer = null))
                avtaler.upsert(AvtaleFixtures.oppfolging.copy(id = avtale2Id, avtalenummer = null))

                val get = avtaler.get(avtale1Id)
                val avtale1Avtalenummer = get.shouldNotBeNull().avtalenummer.shouldNotBeNull()
                val avtale2Avtalenummer = avtaler.get(avtale2Id).shouldNotBeNull().avtalenummer.shouldNotBeNull()
