...
class TilsagnServiceTest : FunSpec({
    ...
    context("opprett tilsagn") {
        ...
        test("genererer løpenummer og bestillingsnummer") {
            ...
            database.run {
                val aft1 = queries.gjennomforing.getGjennomforingAvtaleOrError(domain2.gjennomforinger[0].id)
                ...
                val aft2 = queries.gjennomforing.getGjennomforingAvtaleOrError(domain2.gjennomforinger[1].id)
    ...
    context("beslutt tilsagn") {
        ...
        test("løpenummer beholdes når tilsagn blir returnert") {
            val aft1 =
                database.run { queries.gjennomforing.getGjennomforingAvtaleOrError(GjennomforingFixtures.AFT1.id) }
