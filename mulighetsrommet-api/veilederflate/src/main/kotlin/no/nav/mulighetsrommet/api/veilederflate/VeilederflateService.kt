...
class VeilederflateService(
    ...
    private val sanityService: VeilederflateSanityService,
) {
    ...
    private suspend fun toVeilederflateTiltak(gjennomforing: VeilederflateTiltakDbo): VeilederflateTiltak {
