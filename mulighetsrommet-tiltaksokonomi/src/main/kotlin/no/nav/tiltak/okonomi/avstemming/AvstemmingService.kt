 ...
 *
 * Filnavn:
 * ååååmmdd_LT_tiltak_avstemming_dag. LT (lønnstilskudd) for å skille disse fra Arena-filene.
 *
...
class AvstemmingService(
    ...
    companion object {
        ...
        fun filename(tidspunkt: LocalDateTime) = "${tidspunkt.format(DateTimeFormatter.ofPattern("yyyyMMdd"))}_LT_tiltak_avstemming_dag.csv"
    }
}
...
fun Bestilling.toCSVRad(): String {
    ...
    data.add(if (this.annullering != null) "Annulert" else "Godkjent")
