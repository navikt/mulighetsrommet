...
object OebsMeldingMapper {
    fun toOebsBestillingMelding(
        ...
        return OebsBestillingMelding(
            kilde = bestilling.okonomiSystem.toOebsKilde(),
    ...
    fun OkonomiSystem.toOebsKilde(): OebsKilde = when (this) {
        OkonomiSystem.TILTAKSADMINISTRASJON -> OebsKilde.TILTADM
        OkonomiSystem.EKSPERTBISTAND -> OebsKilde.EKSPBIST
    }
}
