...
class EkspertbistandBestillingConsumerTest : FunSpec({
    ...
    fun opprettBestillingMelding(
        ...
        okonomiSystem: OkonomiSystem = OkonomiSystem.EKSPERTBISTAND,
    ...
    test("avviser melding når bestillingsnummer ikke starter med 'E-'") {
        ...
        exception.message shouldBe "Ugyldig bestillingsnummer=A-1-1 fra Ekspertbistand, må starte med 'E-'"

        coVerify(exactly = 0) { okonomi.opprettBestilling(any()) }
    }

    test("avviser bestilling-melding når okonomiSystem ikke er EKSPERTBISTAND") {
        ...
        exception.message shouldBe "Ugyldig system TILTAKSADMINISTRASJON fra Ekspertbistand"
